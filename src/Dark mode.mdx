...
```tsx
import { applyDocumentTheme } from "@superlayzer/widget-ui/theme"
...
```tsx
import { getDocumentTheme } from "@superlayzer/widget-ui/theme"
...
```tsx
import { useDocumentTheme } from "@superlayzer/widget-ui/theme"

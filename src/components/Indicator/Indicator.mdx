...
```jsx
import { LoadingIndicator } from "@superlayzer/widget-ui/components/Indicator";
```
...
```jsx
import { CircularProgress } from "@superlayzer/widget-ui/components/Indicator";
```
...
```jsx
import { LoadingDots } from "@superlayzer/widget-ui/components/Indicator";
```
